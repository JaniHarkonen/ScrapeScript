...
export default function compileReturn(nTarget, context) {
  ...
  compResult.add(new Snippet(new Instruction(OP.cpsh, returnedValue)));
  compResult.add(new Snippet(new Instruction(OP.RETURN)));
  return compResult;
};